...
From:
    ba.Timer((POWERUP_WEAR_OFF_TIME - 2000),ba.WeakCallStrict(self._multi_bomb_wear_off_flash),timeformat=ba.TimeFormat.MILLISECONDS)
To:
    ba.Timer((POWERUP_WEAR_OFF_TIME - 2000 / 1000),ba.WeakCallStrict(self._multi_bomb_wear_off_flash))
From:
...
def api6_to_api8(content: str, plugin_type: str) -> str:
    ...
    # Api 6 support
    content = content.replace(
        '# ba_meta require api 6', '# ba_meta require api 8'
    )
    ...
    match = re.search(
        r'^(import\s+[\w]+(\s*,\s*[\w]+)*)', content, flags=re.MULTILINE
    )
    affected_methods = [
        'build_number',
        'device_name',
    ...
    content = content.replace(
        'bauiv1.app.ui_v1.set_main_menu_window',
        'bauiv1.app.ui_v1.set_main_window',
    )

    content = content.replace(
        'babase.app.accounts_v1', 'bauiv1.app.classic.accounts'
    )
    ...
    if plugin_type == 'client':
        content = content.replace(
            '_babase.screenmessage', 'bauiv1.screenmessage'
        )
        content = content.replace(
            'babase.screenmessage', 'bauiv1.screenmessage'
        )
        ...
        content = content.replace(
            'babase.getcollisionmesh', 'bauiv1.getcollisionmesh'
        )
    else:
        ## For transmission:
        content = content.replace(
            '_babase.screenmessage', 'bascenev1.broadcastmessage'
        )
        content = content.replace(
            'babase.screenmessage', 'bascenev1.broadcastmessage'
        )
        ...
        content = content.replace(
            'babase.getcollisionmesh', 'bascenev1.getcollisionmesh'
        )
    ###################################################################################
    content = content.replace(
        'babase.getcollidemesh', 'bascenev1.getcollisionmesh'
    )
    ...
    content = content.replace(
        'babase.IntChoiceSetting', 'bascenev1.IntChoiceSetting'
    )
    content = content.replace(
        'babase.FloatChoiceSetting', 'bascenev1.FloatChoiceSetting'
    )
    ...
    content = content.replace(
        'babase.PlayerDiedMessage', 'bascenev1.PlayerDiedMessage'
    )
    ...
    content = content.replace(
        'babase.FreeForAllSession', 'bascenev1.FreeForAllSession'
    )
    content = content.replace(
        'babase.DualTeamSession', 'bascenev1.DualTeamSession'
    )
    content = content.replace(
        'babase.MultiTeamSession', 'bascenev1.MultiTeamSession'
    )
    ...
    content = content.replace(
        'babase.TeamGameActivity', 'bascenev1.TeamGameActivity'
    )
    ...
    content = content.replace(
        'babase.WeakCallStrict', 'bascenev1.WeakCallStrict'
    )
    content = content.replace('babase.DieMessage', 'bascenev1.DieMessage')
    content = content.replace(
        'babase.OutOfBoundsMessage', 'bascenev1.OutOfBoundsMessage'
    )
    content = content.replace(
        'babase.DroppedMessage', 'bascenev1.DroppedMessage'
    )
    ...
    content = content.replace('babase.getactivity', 'bascenev1.getactivity')
    content = content.replace(
        'babase.CelebrateMessage', 'bascenev1.CelebrateMessage'
    )
    ...
    content = content.replace(
        'babase.PickedUpMessage', 'bascenev1.PickedUpMessage'
    )
    content = content.replace(
        'babase.PowerupMessage', 'bascenev1.PowerupMessage'
    )
    content = content.replace('babase.FreezeMessage', 'bascenev1.FreezeMessage')
    content = content.replace(
        'with babase.ContextRef(activity):', 'with activity.context:'
    )
    content = content.replace('babase.Context', 'babase.ContextRef')
    content = content.replace(
        'babase._dualteamsession', 'bascenev1._dualteamsession'
    )
    content = content.replace(
        'babase._freeforallsession', 'bascenev1._freeforallsession'
    )
    content = content.replace(
        'babase._multiteamsession', 'bascenev1._multiteamsession'
    )
    ...
    content = content.replace(
        'babase.app.spaz_appearances', 'babase.app.classic.spaz_appearances'
    )
    ...
    content = content.replace(
        '_babase.disconnect_client', '_bascenev1.disconnect_client'
    )
    content = content.replace(
        '_babase.get_game_roster', 'bascenev1.get_game_roster'
    )
    content = content.replace(
    ...
    content = content.replace(
        '_babase.new_host_session', 'bascenev1.new_host_session'
    )
    ...
    content = content.replace(
        '_babase.app.coop_session_args', 'babase.app.classic.coop_session_args'
    )
    content = content.replace(
        '_babase.app.campaigns', 'babase.app.classic.campaigns'
    )
    ...
    content = content.replace('babase.widget', 'bauiv1.widget')
    content = content.replace(
        'babase.containerwidget', 'bauiv1.containerwidget'
    )
    ...
    content = content.replace(
        'babase.show_damage_count', 'bascenev1.show_damage_count'
    )
    ...
    content = content.replace(
        'babase.PowerupAcceptMessage', 'bascenev1.PowerupAcceptMessage'
    )
    content = content.replace('babase._gameutils', 'bascenev1._gameutils')
    ...
    content = content.replace(
        '_babase.get_special_widget', 'bauiv1.get_special_widget'
    )
    ...
    content = content.replace(
        '_babase.add_transaction', 'bauiv1.app.plus.add_v1_account_transaction'
    )
    content = content.replace(
    ...
    content = content.replace(
        'babase.internal.connect_to_party', 'bascenev1.connect_to_party'
    )
    content = content.replace(
    ...
    content = content.replace(
        'babase.internal.DEFAULT_TEAM_COLORS', 'bascenev1.DEFAULT_TEAM_COLORS'
    )
    content = content.replace(
        'babase.internal.DEFAULT_TEAM_NAMES', 'bascenev1.DEFAULT_TEAM_NAMES'
    )
    content = content.replace(
        'babase.internal.JoinActivity', 'bascenev1.JoinActivity'
    )
    content = content.replace(
        'babase.internal.LoginAdapter', 'babase._login.LoginAdapter'
    )
    content = content.replace(
    ...
    content = content.replace(
        'babase.internal.ScoreScreenActivity', 'bascenev1.ScoreScreenActivity'
    )
    content = content.replace(
    ...
    content = content.replace(
        'babase.internal.appnameupper', 'babase.appnameupper'
    )
    content = content.replace(
    ...
    content = content.replace(
        'babase.internal.chatmessage', 'bascenev1.chatmessage'
    )
    content = content.replace(
        'babase.internal.commit_app_config', 'bauiv1.commit_app_config'
    )
    content = content.replace(
        'babase.internal.disconnect_client', 'bascenev1.disconnect_client'
    )
    content = content.replace(
        'babase.internal.disconnect_from_host', 'bascenev1.disconnect_from_host'
    )
    content = content.replace(
    ...
    content = content.replace(
        'babase.internal.end_host_scanning', 'bascenev1.end_host_scanning'
    )
    content = content.replace(
        'babase.internal.fade_screen', 'bauiv1.fade_screen'
    )
    content = content.replace(
        'babase.internal.filter_playlist', 'bascenev1.filter_playlist'
    )
    content = content.replace(
    ...
    content = content.replace(
        'babase.internal.get_chat_messages', 'bascenev1.get_chat_messages'
    )
    content = content.replace(
    ...
    content = content.replace(
        'babase.internal.get_game_port', 'bascenev1.get_game_port'
    )
    content = content.replace(
        'babase.internal.get_game_roster', 'bascenev1.get_game_roster'
    )
    content = content.replace(
    ...
    content = content.replace(
        'babase.internal.get_ip_address_type', 'babase.get_ip_address_type'
    )
    content = content.replace(
    ...
    content = content.replace(
        'babase.internal.get_map_class', 'bascenev1.get_map_class'
    )
    content = content.replace(
    ...
    content = content.replace(
        'babase.internal.get_news_show', '_babase.app.plus.get_news_show'
    )
    content = content.replace(
        'babase.internal.get_next_tip', 'bascenev1.app.classic.get_next_tip'
    )
    content = content.replace(
        'babase.internal.get_player_colors', 'bascenev1.get_player_colors'
    )
    content = content.replace(
    ...
    content = content.replace(
        'babase.internal.get_price', 'bauiv1.app.plus.get_price'
    )
    content = content.replace(
    ...
    content = content.replace(
        'babase.internal.get_purchased', 'bauiv1.app.plus.get_purchased'
    )
    content = content.replace(
        'babase.internal.get_purchases_state', '_baplus.get_purchases_state'
    )
    content = content.replace(
        'babase.internal.get_qrcode_texture', 'bauiv1.get_qrcode_texture'
    )
    content = content.replace(
        'babase.internal.get_random_names', 'bascenev1.get_random_names'
    )
    content = content.replace(
        'babase.internal.get_remote_app_name', 'bascenev1.get_remote_app_name'
    )
    content = content.replace(
    ...
    content = content.replace(
        'babase.internal.get_replays_dir', 'babase.get_replays_dir'
    )
    content = content.replace(
        'babase.internal.get_special_widget', 'bauiv1.get_special_widget'
    )
    content = content.replace(
    ...
    content = content.replace(
        'babase.internal.get_string_height', 'babase.get_string_height'
    )
    content = content.replace(
        'babase.internal.get_string_width', 'babase.get_string_width'
    )
    content = content.replace(
    ...
    content = content.replace(
        'babase.internal.get_trophy_string', 'bascenev1.get_trophy_string'
    )
    content = content.replace(
        'babase.internal.get_type_name', 'babase.get_type_name'
    )
    content = content.replace(
        'babase.internal.get_ui_input_device', 'bascenev1.get_ui_input_device'
    )
    content = content.replace(
    ...
    content = content.replace(
        'babase.internal.get_v2_fleet', '_baplus.get_v2_fleet'
    )
    content = content.replace(
        'babase.internal.getcampaign', 'bauiv1.app.classic.getcampaign'
    )
    content = content.replace('babase.internal.getclass', 'babase.getclass')
    content = content.replace(
        'babase.internal.getinputdevice', 'bascenev1.getinputdevice'
    )
    content = content.replace(
        'babase.internal.has_gamma_control', 'babase.has_gamma_control'
    )
    content = content.replace(
        'babase.internal.has_video_ads', 'bauiv1.has_video_ads'
    )
    content = content.replace(
        'babase.internal.have_incentivized_ad', 'bauiv1.have_incentivized_ad'
    )
    content = content.replace(
        'babase.internal.have_permission', 'babase.have_permission'
    )
    content = content.replace(
    ...
    content = content.replace(
        'babase.internal.host_scan_cycle', 'bascenev1.host_scan_cycle'
    )
    content = content.replace(
        'babase.internal.in_game_purchase', 'bui.app.plus.in_game_purchase'
    )
    content = content.replace(
    ...
    content = content.replace(
        'babase.internal.is_blessed', 'bui.app.plus.is_blessed'
    )
    ...
    content = content.replace(
        'babase.internal.is_in_replay', 'bascenev1.is_in_replay'
    )
    content = content.replace(
        'babase.internal.is_party_icon_visible', 'bauiv1.is_party_icon_visible'
    )
    content = content.replace(
        'babase.internal.is_running_on_fire_tv', 'babase.is_running_on_fire_tv'
    )
    content = content.replace(
        'babase.internal.is_xcode_build', 'babase.is_xcode_build'
    )
    content = content.replace('babase.internal.json_prep', 'babase.json_prep')
    content = content.replace(
        'babase.internal.lock_all_input', 'babase.lock_all_input'
    )
    content = content.replace(
    ...
    content = content.replace(
        'babase.internal.new_host_session', 'bascenev1.new_host_session'
    )
    content = content.replace(
        'babase.internal.new_replay_session', 'bascenev1.new_replay_session'
    )
    content = content.replace(
        'babase.internal.open_file_externally', 'bauiv1.open_file_externally'
    )
    content = content.replace(
        'babase.internal.power_ranking_query', '_baplus.power_ranking_query'
    )
    content = content.replace(
    ...
    content = content.replace(
        'babase.internal.register_map', 'bascenev1.register_map'
    )
    content = content.replace(
    ...
    content = content.replace(
        'babase.internal.request_permission', 'babase.request_permission'
    )
    content = content.replace(
        'babase.internal.reset_achievements', '_baplus.reset_achievements'
    )
    content = content.replace(
    ...
    content = content.replace(
        'babase.internal.restore_purchases', '_baplus.restore_purchases'
    )
    content = content.replace(
    ...
    content = content.replace(
        'babase.internal.run_stress_test', 'babase.app.classic.run_stress_test'
    )
    content = content.replace(
    ...
    content = content.replace(
        'babase.internal.set_party_window_open', 'bauiv1.set_party_window_open'
    )
    content = content.replace(
    ...
    content = content.replace(
        'babase.internal.set_ui_input_device', 'babase.set_ui_input_device'
    )
    content = content.replace(
    ...
    content = content.replace(
        'babase.internal.show_online_score_ui', 'bauiv1.show_online_score_ui'
    )
    content = content.replace(
        'babase.internal.sign_in_v1', 'babase.app.plus.sign_in_v1'
    )
    content = content.replace(
        'babase.internal.sign_out_v1', 'babase.app.plus.sign_out_v1'
    )
    content = content.replace(
        'babase.internal.submit_score', 'bascenev1.app.plus.submit_score'
    )
    content = content.replace(
        'babase.internal.tournament_query', '_baplus.tournament_query'
    )
    content = content.replace(
        'babase.internal.unlock_all_input', 'babase.unlock_all_input'
    )
    content = content.replace(
        'babase.internal.value_test', 'bauiv1.app.classic.value_test'
    )
    content = content.replace(
        'babase.internal.workspaces_in_use', 'babase.workspaces_in_use'
    )
    content = content.replace(
        'babase.internal.dump_tracebacks', 'babase._apputils.dump_app_state'
    )
    content = content.replace(
        'babase.internal.show_app_invite', '_bauiv1.show_app_invite'
    )
    content = content.replace(
    ...
    content = content.replace(
        '_babase.disconnect_from_host', 'bascenev1.disconnect_from_host'
    )
    content = content.replace(
        'babase.disconnect_from_host', 'bascenev1.disconnect_from_host'
    )
    content = content.replace(
        '_babase.connect_to_party', 'bascenev1.connect_to_party'
    )
    content = content.replace(
        'babase.connect_to_party', 'bascenev1.connect_to_party'
    )
    content = content.replace(
        'babase.set_party_window_open', 'bauiv1.set_party_window_open'
    )
    content = content.replace(
        'babase.set_party_window_open', 'bauiv1.set_party_window_open'
    )
    ...
    content = content.replace(
        'babase.app.build_number', 'babase.app.env.engine_build_number'
    )
    content = content.replace(
        'babase.app.device_name', 'babase.app.env.device_name'
    )
    content = content.replace(
        'babase.app.config_file_path', 'babase.app.env.config_file_path'
    )
    content = content.replace(
        'babase.app.version', 'babase.app.env.engine_version'
    )
    ...
    content = content.replace(
        'babase.app.data_directory', 'babase.app.env.data_directory'
    )
    content = content.replace(
    ...
    content = content.replace(
        'babase.app.python_directory_app', 'babase.app.env.python_directory_app'
    )
    content = content.replace(
    ...
    content = content.replace(
        'babase.app.api_version', 'babase.app.env.api_version'
    )
    ...
    content = content.replace(
        'babase.app.protocol_version', 'bascenev1.protocol_version'
    )
    content = content.replace(
        'bascenev1.get_connection_to_host_info',
    ...
    content = content.replace(
        '_babase.get_game_port', 'bascenev1.get_game_port'
    )
    content = content.replace(
        '_babase.get_chat_messages', 'bascenev1.get_chat_messages'
    )
    content = content.replace(
    ...
    content = content.replace(
        'import bascenev1 as bascenev1lib', 'import bascenev1lib'
    )
    ...
    content = re.sub(
        r'bs\.Timer\(([^)]*)\bTimeType\.REAL\b([^)]*)\)',
        r'babase.AppTimer(\1\2)',
        content,
    )
...
def api8_to_api9(content: str) -> str:
    ...
    content = content.replace(
        'bs.get_connection_to_host_info', 'get_connection_to_host_info_2'
    )
    # replace get_connection_to_host_info_2(args)["name"] with et_connection_to_host_info_2(args).name
    content = re.sub(
        r'bs\.get_connection_to_host_info_2\((.*?)\)\\[\"name\"]',
        r'bs.get_connection_to_host_info_2(\1).name',
        content,
    )
    ...
    content = content.replace(
        'babase.env()["ui_scale"]', 'babase.get_ui_scale()'
    )
...
def main() -> None:
    parser = argparse.ArgumentParser(
        description='Port plugins from api 6 to api 9', exit_on_error=False
    )
    parser.add_argument(
        '-f', '--file', required=True, type=str, help='File path of the plugin.'
    )
    parser.add_argument(
        '-t',
        '--type',
    ...
    if encoding := detect_file_encoding(
        file_path
    ):  # behold the walrus operator XDD
        with open(file_path, encoding=encoding) as read_f:
