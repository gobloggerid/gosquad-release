...
class BridgitParallelo(bs.Map):
    ...
    defs.points['spawn1'] = (-5.869295124, 3.715437928, -3.617274877) + (
        0.9410329222,
        1.0,
        0.818908238,
    )
    defs.boxes['area_of_interest_bounds'] = (
        (-0.2457963347, 3.828181068, -3.528362695)
        + (0.0, 0.0, 0.0)
    ...
    def map_extend(self):
        ...
        #     actions=(
        #         ('modify_part_collision', 'collide', True),
        #         ( 'call','at_connect',babase.CallStrict(self._handle_player_pad_collide,real )),
        #     ),
        #     )
        ...
        mnode = bs.newnode(
            'math',
            owner=self.ud_1_r,
            attrs={'input1': (0, -2.9, 0), 'operation': 'add'},
        )
        ...
        mnode = bs.newnode(
            'math',
            owner=self.ud_2_r,
            attrs={'input1': (0, -1.8, 0), 'operation': 'add'},
        )
