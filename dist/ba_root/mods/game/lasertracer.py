...
class LaserTracerGame(bs.TeamGameActivity[Player, Team]):
    ...
    def create_laser(self) -> None:
        bs.timer(6, babase.CallStrict(self.LRlaser, True))

        bs.timer(7, babase.CallStrict(self.UDlaser, True))
        bs.timer(30, babase.CallStrict(self.create_laser))
    ...
    def LRlaser(self, left):
        ...
        bs.timer(20, babase.CallStrict(ud_1_r.delete))
        t = random.randrange(7, 13)
        bs.timer(t, babase.CallStrict(self.LRlaser, random.randrange(0, 2)))
    ...
    def UDlaser(self, up):
        ...
        bs.timer(17, babase.CallStrict(ud_2_r.delete))
        t = random.randrange(6, 13)
        bs.timer(t, babase.CallStrict(self.UDlaser, random.randrange(0, 2)))
