...
class BlockDashGame(EliminationGame):
    ...
    def add_wall(self):
        ...
        ud_1_r = bs.newnode(
            ...
            attrs={
                ...
                'scale': (14.5, 1, 14.5),
                'type': 'box',
                'materials': [shared.footing_material, pwm],
            },
        )
        ...
        bs.timer(8, babase.CallStrict(self.create_block_wall_easy))
        self.gate_count = 4
        self.wall_count = 0
    ...
    def create_block_wall_hardest(self):
        ...
        for i in range(7):
            ...
            x = x + 0.85
        bs.timer(1.5, babase.CallStrict(self.create_wall))
        bs.timer(15, babase.CallStrict(self.create_block_wall_hardest))
    ...
    def create_block_wall_hard(self):
        ...
        if self.wall_count < 4:
            bs.timer(12, babase.CallStrict(self.create_block_wall_hard))
        else:
            bs.timer(
                7, babase.CallStrict(self.create_block_wall_hard)
            )  # hardest too heavy to play
    ...
    def create_block_wall_easy(self):
        ...
        if self.wall_count < 5:
            bs.timer(11, babase.CallStrict(self.create_block_wall_easy))
        else:
            self.wall_count = 0
            bs.timer(15, babase.CallStrict(self.create_block_wall_hard))
    ...
    def create_block(self, x, y):
        ...
        _rcombine = bs.newnode(
            'combine', owner=ud_1_r, attrs={'input0': x, 'input1': y, 'size': 3}
        )
        bs.animate(_rcombine, 'input2', {0: -12, 11: 4})
        _rcombine.connectattr('output', ud_1_r, 'position')

        bs.timer(11, babase.CallStrict(ud_1_r.delete))
