...
from bascenev1lib.actor.spazbot import ChargerBotPro, SpazBotSet, TriggerBotPro
    ...
    def keep_vel(self) -> None:
        if self.node and not self.died:
            ...
            if self.moving:
                ...
                bs.timer(0.1, bs.WeakCallStrict(self.keep_vel))
            else:
...
class AbyssPlayerSpaz(PlayerSpaz):
    def __init__(
        ...
        bs.timer(
            ...
            bs.WeakCallStrict(self.safe_connect_controls_to_player),
        )
    ...
    def fix_2D_position(self) -> None:
        self.node.fly = True
        bs.timer(0.02, bs.WeakCallStrict(self.disable_fly))
    ...
    def curse(self) -> None:
        ...
        if not self._cursed:
            ...
            if self.curse_time == -1:
                ...
                bs.timer(15, bs.WeakCallStrict(self.curse_explode))
...
class AbyssGame(bs.TeamGameActivity[Player, Team]):
    ...
    def __init__(self, settings: dict):
        ...
        self.peace_time = float(settings.get('Peace Time', 5))
        self.npc_density = float(settings.get('NPC Density', 2))
    ...
    def get_instance_description(self) -> str | Sequence:
        return 'Survive as long as you can in the Abyss!'
    ...
    def on_begin(self) -> None:
        ...
        bs.timer(
            ...
            bs.WeakCallStrict(self.add_foothold),
            repeat=True,
        )
        ...
        bs.timer(
            self.peace_time + 0.1,
            bs.WeakCallStrict(self.tip_hint, 'You can punch your enemies now!'),
        )
        bs.timer(6.0, bs.WeakCallStrict(self.faster_speed), repeat=True)
