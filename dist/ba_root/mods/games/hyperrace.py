...
class RaceGame(bs.TeamGameActivity[Player, Team]):
                ...
                if last_region >= len(self._regions) - 2 and this_region == 0:
                    ...
                    # They've just finished a lap but not the race.
                        ...
                        try:
                            ...
                            babase.applog.exception('Error printing lap.')
        ...
        if (
            ...
            for otherplayer in player.team.players:
                ...
                try:
                    ...
                    babase.applog.exception('Error sending DieMessage.')
    ...
    def _obstacles(self) -> None:
        ...
        bs.timer(
            0.1,
            bs.WeakCallStrict(
                self._tnt, (-3.2, 5, 1), (0, 0, 0), 1.0, (0, 20, 60)
            ),
            repeat=True,
        )
        ...
        bs.timer(
            1.6,
            bs.WeakCallStrict(
                self._bomb, 'impact', (6, 7, 1), (0, 0, 0), 1.0, 1.0
            ),
            repeat=True,
        )
        bs.timer(
            1.6,
            bs.WeakCallStrict(
                self._bomb, 'impact', (6.8, 7, 1), (0, 0, 0), 1.0, 1.0
            ),
            repeat=True,
        )
        bs.timer(
            1.6,
            bs.WeakCallStrict(
                self._bomb, 'impact', (7.6, 7, 1), (0, 0, 0), 1.0, 1.0
            ),
            repeat=True,
        )
        ...
        bs.timer(
            1.6,
            bs.WeakCallStrict(
                self._bomb, 'impact', (6, 7, -8), (0, 0, 0), 1.0, 1.0
            ),
            repeat=True,
        )
        bs.timer(
        ...
        bs.timer(
            1.6,
            bs.WeakCallStrict(self._powerup, (2, 5, -5), 'curse', (0, 20, -3)),
            repeat=True,
        )
        bs.timer(
            1.6,
            bs.WeakCallStrict(self._powerup, (4, 5, -5), 'curse', (0, 20, -3)),
            repeat=True,
        )
        ...
        for player in self.players:
            if player.actor is not None:
                try:
                    ...
                    babase.applog.exception('Error in race player connects.')
        assert self._timer is not None
        self._timer.start()
