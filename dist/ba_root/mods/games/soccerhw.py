...
NormalPlayerSpaz = PlayerSpaz  # storing the original spaz


class NewPlayerSpaz(PlayerSpaz):  # tweaked spaz class
    def __init__(
        self,
        player: bs.Player,
        ...
        self.equip_boxing_gloves()  # our pretty Gloves
...
class Puck(bs.Actor):
    ...
    def __init__(self, position: Sequence[float] = (0.0, 0, 0.0)):
        ...
        bs.animate(
            self.node,
            'mesh_scale',
            {0: MIN_SPHERE_SIZE, 0.2: 0.33, 0.26: 0.25},
        )
...
class HockeyGame(bs.TeamGameActivity[Player, Team]):
    ...
    def get_supported_maps(cls, sessiontype: type[bs.Session]) -> list[str]:
        ...
        return [
            ...
            'Football Stadium V2',
            'Soccer Stadium V2',
            'Soccer Stadium V2 Special',
            'Soccer Stadium V2 Copa Libertadores',
        ]
    ...
    def __init__(self, settings: dict):
        ...
        self._puck_sound = bs.getsound('block')
