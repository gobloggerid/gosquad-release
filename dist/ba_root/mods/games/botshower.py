...
class BotShowerGame(bs.TeamGameActivity[Player, Team]):
    ...
    available_settings = [
        bs.BoolSetting('Curse Player', default=False),
    ...
    def __init__(self, settings: dict) -> None:
        ...
        self._curse_player = settings.get('Curse Player', False)
    ...
    def on_begin(self) -> None:
        ...
        if self._epic_mode:
            bs.timer(0.1, self._start_spawning_bots)
        else:
            bs.timer(3.0, self._start_spawning_bots)
    ...
    def _start_spawning_bots(self) -> None:
        bs.timer(0.2, self._spawn_bot)
        bs.timer(0.7, self._spawn_bot)
