...
class Ball(bs.Actor):
    ...
    def __init__(
        ...
        bs.timer(2.5, bs.WeakCallStrict(self.handlemessage, bs.DieMessage()))
...
class DodgeTheBallGame(bs.TeamGameActivity[Player, Team]):
