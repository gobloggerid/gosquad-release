...
class RunningBombGame(bs.TeamGameActivity[Player, Team]):
        ...
        bs.NodeActor(
            bs.newnode(
                ...
                attrs={
                    ...
                    'type': 'box',
                    'materials': [
                        self.kill_bomb_region_material,
    ...
    def _get_ffa_start_position(self) -> Sequence[float, float, float]:
        return self.map.get_ffa_start_position(self.players)

    # overriding the default character spawning..
    def spawn_player(self, player: Player) -> bs.Actor:
        spaz = self.spawn_player_spaz(player, self._get_ffa_start_position())
    ...
    def _drop_bomb_cluster(self) -> None:
        ...
        for _i in range(random.randrange(1, 3)):
            ...
            vel = (-20, 2, 0)
            bs.timer(delay, bs.CallStrict(self._drop_bomb, vel))
            delay += 0.1
